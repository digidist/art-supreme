			...
			foreach ($rows as $row) {
				...
				<tr>
					...
					<td class="ulp-popups-actions">
						...
						<a class="thickbox" href="'.admin_url('admin.php').'?action=ulp-campaigns-stats&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('Statistics', 'ulp').': '.esc_html($row['title']).'"><i class="fas fa-chart-bar"></i></a>
		...
		if (sizeof($rows) > 0) {
			foreach ($rows as $row) {
				...
				<tr>
					...
					<td class="ulp-popups-actions">
						<a class="thickbox" href="'.admin_url('admin.php').'?action=ulp-subscribers-details&id='.$row['id'].'&ac='.$ulp->random_string().'" title="'.__('View details', 'ulp').'"><i class="fas fa-list-alt"></i></a>
